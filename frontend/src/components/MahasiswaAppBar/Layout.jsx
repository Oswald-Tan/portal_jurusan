        ...
        <div className="app-bar-mahasiswa-container">
          ...
          <div className="app-bar-head-mahasiswa">
            ...
            <div className="app-bar-user">
              <div className="app-bar-name">
                ...
                <button type="button" onClick={openSidebar} className="user-icon-bg-mahasiswa">
                  <RiMenu4Fill size={14} className="user-icon-menu-mahasiswa sidebar-mahasiswa-open-btn" />
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="app-bar-details-mahasiswa">
            <div className="app-bar-details-info-mahasiswa">
              <img src={ProfileMahasiswa} alt="profile mahasiswa" className="profile-mahasiswa" />
              <div className="app-bar-info-mahasiswa">
                ...
                <div className="app-bar-status">
                  ...
                  <span className="app-bar-border-status">{detailMahasiswa.statusMahasiswa === null ? 'Loading...' : detailMahasiswa.statusMahasiswa}</span>
                </div>
              </div>
              ...
              <div className="app-bar-info-kanan">
                ...
                <p className="app-bar-dosenwali">
                  Dosen Wali <span className="app-bar-dosenwali-name">Asep Napi Rudon</span>
                </p>
              </div>
            </div>
          </div>
