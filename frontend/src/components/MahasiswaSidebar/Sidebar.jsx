        ...
        <div className="sidebar-body-mahasiswa">
          <div className="sidebar-menu-mahasiswa">
            <ul className="menu-list-mahasiswa">
              ...
              <li className="menu-item-mahasiswa">
                <Link
                  ...
                  onClick={() => {
                    ...
                    handleSubmenuClick("Jadwal");
                  }}
                >
                  <span className="menu-link-icon-mahasiswa">
                    <AiFillSchedule size={20} />
                  </span>
                  <span className={`menu-link-text-mahasiswa ${isExpanded ? "menu-list-expanded" : ""}`}>Jadwal</span>
                </Link>
              </li>
              ...
              <li className="menu-item-mahasiswa">
                <div
                  className={`menu-link-mahasiswa ${activeMenu === "???" ? "active" : ""}`}
                  onClick={() => {
                    handleSetActiveMenu("???");
                    toggleHimajuSubMenu();
                  }}
                >
                  ...
                  <span className={`menu-link-text-mahasiswa ${isExpanded ? "menu-list-expanded" : ""}`}>??</span>
                  <span className={`submenu-arrow-mahasiswa ${himajuSubMenuOpen ? "open" : ""} ${isExpanded ? "menu-list-expanded" : ""}`}>
                ...
                <ul className={`submenu-list-mahasiswa ${himajuSubMenuOpen ? "open" : ""}`}>
                  <div className="divider-list-mahasiswa"></div>
                  <li className="submenu-item-mahasiswa">
                    <Link to="/mahasiswa/himaju/kegiatan1" className="submenu-link-mahasiswa">
                  ...
                  <li className="submenu-item-mahasiswa">
                    <Link to="/mahasiswa/himaju/kegiatan2" className="submenu-link-mahasiswa">
                      <span className="submenu-link-icon-mahasiswa">
                        <FaDotCircle size={13} />
                      </span>
                      Kegiatan 2
